...
namespace Fsocial.Items.Fpickaxe //название вашего мода
{
    ...
    public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("F pickaxe"); //название объекта в игре
        ...
        public override void SetDefaults() //свойства объекта
        {
            ...
            item.UseSound = SoundID.Item1;// mod.GetLegacySoundSlot(SoundType.Item, @"Sounds\sound-rassen"); звук объекта
